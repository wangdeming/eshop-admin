            ...
            switch (data.data.order.status){
                ...
                case 2:
                    var orderStatusHtml = '<div class="statusDiv">等待商家确认</div>'
                        +'<div><button type="button" class="btn btn-primary" onclick="confirm()" style="width: 120px;height: 34px;color: #FFFFFF;margin-top: 10px;">立即确认</button></div>';
                    $("#orderStatus").empty().append(orderStatusHtml);
                    $("#circle1").text("√");
                    $("#circle2").text("√");
                    $("#line2").css("background-color","#f2f8f9");
                ...
                case 3:
                    var orderStatusHtml = '<div class="statusDiv">等待买家入住</div>'
                        +'<div><button type="button" class="btn btn-primary" onclick="confirmCheckIn()" style="width: 120px;height: 34px;color: #FFFFFF;margin-top: 10px;">确认入住</button></div>';
                    $("#orderStatus").empty().append(orderStatusHtml);
                    $("#circle1").text("√");
                    $("#circle2").text("√");
                    $("#circle3").text("√");
