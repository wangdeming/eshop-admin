...
AdInfoManagerAccount.openEdit = function (id,sequence) {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: [Feng.ctxPath + '/platform/adInfoManager/shopGoodsAd_update/' + id],
        sequence:sequence
    });
...
AdInfoManagerAccount.openAdd = function () {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: [Feng.ctxPath + '/platform/adInfoManager/shopGoodsAdAdd']
    });
    this.layerIndex = index;
};
...
$(function () {
    ...
    var queryData = {};
    queryData['limit'] = 20;
    queryData['adPosition'] = 'shopGoodsAd';
