...
MenuInfoDlg.collectData = function () {
    this.set('id').set('name').set('code').set('pcode').set('url').set('num').set('levels').set('icon').set("ismenu").set("shopType");
};
...
$(function () {
    ...
    if($("#shopTypeValue").val() == undefined){
        $("#shopType").val(1);
    }else{
        $("#shopType").val($("#shopTypeValue").val());
    }
});
