...
public class WebProperties {
    ...
    private String masterLoginUrl; // 统一登录入口
    private Integer curSystem; // 当前系统标识
    private String masterDomain; // 统一登录入口域名
    private String domainName; // 一级域名
    ...
    public String getMasterLoginUrl() {
        return masterLoginUrl;
    }

    public void setMasterLoginUrl(String masterLoginUrl) {
        this.masterLoginUrl = masterLoginUrl;
    }

    public Integer getCurSystem() {
        return curSystem;
    }

    public void setCurSystem(Integer curSystem) {
