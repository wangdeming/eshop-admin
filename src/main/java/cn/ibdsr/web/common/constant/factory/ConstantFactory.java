...
public class ConstantFactory implements IConstantFactory {
    ...
    private GoodsCategoryMapper goodsCategoryMapper = SpringContextHolder.getBean(GoodsCategoryMapper.class);
    private UrlProperties messageProperties = SpringContextHolder.getBean(UrlProperties.class);
    ...
    public String getCacheObject(String para) {
        return ShopLogObjectHolder.me().get().toString();
    }
     ...
     */
    @Override
    public List<Dict> getSubListByName(String name) {
        Dict query = new Dict();
        query.setName(name);
     ...
     */
    @Override
    public List<Dict> getShopTypeList() {
        return getSubListByName("店铺类型");
    }
     ...
     */
    @Override
    public String getGoodsCategoryName(Long categoryId) {
        if (ToolUtil.isEmpty(categoryId)) {
            ...
            goodsCategory = goodsCategoryMapper.selectOne(goodsCategory);
