package cn.ibdsr.web.modular.platform.ordercenter.hotelorder.dao;
...
public interface HotelDao {
     ...
     * @return
     */
    List<HotelOrderListVO> hotelOrderList(@Param("page") Page<HotelOrderListVO> page, @Param("queryDTO") HotelOrderQueryDTO queryDTO);
