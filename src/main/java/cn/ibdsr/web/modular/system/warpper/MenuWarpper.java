...
import cn.ibdsr.web.common.constant.state.IsMenu;
import cn.ibdsr.web.common.constant.state.MenuShopType;
...
public class MenuWarpper extends BaseControllerWarpper {
    ...
    public void warpTheMap(Map<String, Object> map) {
        ...
        map.put("shopTypeName", MenuShopType.valueOf((Integer) map.get("shopType")));
    }
